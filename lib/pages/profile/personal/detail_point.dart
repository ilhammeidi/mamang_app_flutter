  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Your Points', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
        centerTitle: true,
      ),
      body: Container(
        ...
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: <Color>[Colors.blueAccent.shade100, Colors.blueAccent.shade700]
          ),
        ),
        child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
          ...
          FilledButton(
            ...
            child: Text('2x Redeem', style: ThemeText.subtitle2.copyWith(color: Colors.blueAccent, fontWeight: FontWeight.bold)),
          ),
          const VSpace(),
          /// HISTORY
          Expanded(child: 
